...
1. HP Anyware on Windows 2022 instance with EPIC unreal version 5
...
- Visual Studio 2017 (or) 2019 community - UE5
...
**Diagram below is a high-level overview of the Cloud Formation template:**
  ...
  **HP Anyware marketplace image** - Base on selected marketplace image you will have pre-built image with either HP Anyware on Window 2019 server (or) HP Anyware on Windows 2019 server + Epic unreal 4 (or) HP Anyware on Windows 2022 server + Epic unreal 5 and is available in every AWS region. You must subscribe to the AWS marketplace offering before deploying a CFT.
...
[![name] (https://github.com/ChadSmithTeradici/PCoIP-Power-Tools-via-CFT/blob/main/images/UE5-small.png?raw=true)](https://aws.amazon.com/marketplace/pp/prodview-fryvjy6m3qn2q?sr=0-7&ref_=beagle&applicationId=AWSMPContessa &emsp; &emsp;  [![name]
(https://github.com/ChadSmithTeradici/PCoIP-Power-Tools-via-CFT/blob/main/images/Unreal-logo-small.png?raw=true)](https://aws.amazon.com/marketplace/pp/prodview-mj35z5mqzmanm?sr=0-5&ref_=beagle&applicationId=AWSMPContessa)  &emsp; &emsp;  [![name](https://github.com/ChadSmithTeradici/PCoIP-Power-Tools-via-CFT/blob/main/images/blender-small.png?raw=true)](https://aws.amazon.com/marketplace/pp/prodview-boeg6hiewus3o?sr=0-1&ref_=beagle&applicationId=AWSMPContessa)  &emsp; &emsp;  [![name](https://github.com/ChadSmithTeradici/PCoIP-Power-Tools-via-CFT/blob/main/images/o3DE-small.png?raw=true)](https://aws.amazon.com/marketplace/pp/prodview-boeg6hiewus3o?sr=0-1&ref_=beagle&applicationId=AWSMPContessa)  &emsp; &emsp;  [![name](https://github.com/ChadSmithTeradici/PCoIP-Power-Tools-via-CFT/blob/main/images/HPA-small.png)](https://aws.amazon.com/marketplace/pp/prodview-boeg6hiewus3o?sr=0-1&ref_=beagle&applicationId=AWSMPContessa)  
